...
{
public:
    tcp_server(boost::asio::io_service& io_service, void(*newclienthandle)(tcp_connection::pointer));
    ~tcp_server();
    void start_accept();
    ...
    void remove_connection(tcp_connection* connection, remove_tcp_connection_key);
